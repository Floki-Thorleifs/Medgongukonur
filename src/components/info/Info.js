...
class Info extends Component {
  render() {
    return (
      <div>
        <h2>Managing & Treating Gestational Diabetes</h2>
        <h3>How can I manage my gestational diabetes?</h3>
        ...
        <h3>Follow a healthy eating plan</h3>
        ...
        <p>If you’re not eating enough or your blood glucose is too high, your body might make ketones. Ketones in your urine or blood mean your body is using fat for energy instead of glucose. </p>
        <p>Burning large amounts of fat instead of glucose can be harmful to your health and your baby’s health.</p>
        ...
        <h3>How will I know whether my blood glucose levels are on target?</h3>
        ...
        <p>You can keep track of your blood glucose levels using My Daily Blood Glucose Record. You can also use an electronic blood glucose tracking system on your computer or mobile device. Record the results every time you check your blood glucose. Your blood glucose records can help you and your health care team decide whether your diabetes care plan is working. Take your tracker with you when you visit your health care team.</p>
        <h3>How is gestational diabetes treated if diet and physical activity aren’t enough?</h3>
